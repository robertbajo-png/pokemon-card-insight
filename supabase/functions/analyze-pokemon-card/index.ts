...
1. Börja med att zooma in på NEDRE VÄNSTRA HÖRNET för att identifiera set-symbolen och kortnumret (format "X/Y") – var extra uppmärksam där.
...
Svara ENDAST med giltig JSON i detta exakta format (utan extra text):
{
  ...
  "description": "kortbeskrivning"
      ...
      userPrompt = `Analysera detta Pokemon-kort från bilden. Identifiera setet genom att först läsa av symbolen i NEDRE VÄNSTRA HÖRNET och sedan dubbelkolla att kortnumret passar inom setets storlek. Om symbol och nummer inte stämmer, rapportera setet som "Unknown" istället för att gissa.`;
